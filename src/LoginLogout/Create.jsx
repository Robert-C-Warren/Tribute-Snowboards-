    ...
    <div className='card-div'>
        ...
        <div className="card" style={{ width:"25rem" }} >
            <div className="card-body">
                ...
                <input className='first-name elem' type='name' placeholder='First Name' />
                <input className='last-name elem' type='name' placeholder='Last Name' />
                <input className='email elem' type='email' placeholder='Email' />
                <input className='password elem' type='password' placeholder='Password' />
                <input className='confirm-password elem' type='password' placeholder='Confirm Password' />
